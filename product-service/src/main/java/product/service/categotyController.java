...
public class categotyController {
    ...
    // Select all categoty
    @GetMapping("/category")
    public Collection<category> getallcategoty() {
    ...
    public ResponseEntity getAllcategotyById(@PathVariable long ID) {
        Optional<category> optcategoty = categotyRepository.findById(ID);
        ...
        category emp = optcategoty.get();
        return ResponseEntity.ok(emp);
    }
    //Create method for position 
    @PostMapping("/category")
    public ResponseEntity createCategoty(@RequestBody category categoty){
    ...
    // update categoty
    @PutMapping("/category")
    public ResponseEntity<String> updateCategoty( @RequestBody category categoty) {
